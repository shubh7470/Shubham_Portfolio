  ...
  const experiences = [
    {
      ...
      description: [
        'Developed and deployed 2 full-stack mobile applications (React Native + Expo) live on both Play Store and App Store.',
        'Built and maintained backend services using Node.js, PostgreSQL, and Redis for multiple production apps.',
        'Worked across the complete lifecycle — API design, database schema, mobile UI, and deployment.',
        'Collaborated with team to design scalable multi-service architecture for local service and e-commerce platforms.',
      ],
      tech: ['React Native', 'Expo', 'Node.js', 'PostgreSQL', 'Redis', 'REST API'],
    },
    {
      role: 'Full Stack Developer',
      ...
      description: [
        'Lead a development team to design and build scalable web applications using the MERN Stack.',
        'Collaborated with cross-functional teams to integrate AI-driven features improving system efficiency and user engagement.',
        'Managed full project lifecycle: design → development → deployment.',
      ],
      tech: ['React.js', 'Node.js', 'MongoDB', 'Express.js', 'AI Features', 'Cloud'],
    },
    {
      ...
      description: [
        'Learned and worked hands-on with the MERN Stack (MongoDB, Express.js, React.js, Node.js) on live projects.',
        'Assisted in building and testing REST APIs and front-end components under senior developer guidance.',
        'Gained foundational experience in Git version control, debugging, and collaborative development workflows.',
      ],
