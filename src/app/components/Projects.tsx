...
export function Projects() {
  ...
  const projects: ProjectItem[] = [
    ...
    },
    {
      ...
      longDescription: 'Hindustan Mart is a comprehensive mobile shopping application. It features fast product catalog searching, dynamic address management, coupon application, cart checkout, and backend order processing powered by Node.js & PostgreSQL.',
      tech: ['React Native', 'Expo', 'Node.js', 'Express.js', 'PostgreSQL', 'Firebase'],
